...
import com.chess.engine.pieces.Commoner;
...
import com.chess.engine.pieces.SiegeMachine;
import com.chess.engine.pieces.Zebra;
...
public class Board
{
	...
	{	
		this.gameBoard = createrGameBoard(builder);
	...
	//TODO: Check out toString() method and code below in the overridden method // append method ?
	...
	private static List<Tile> createrGameBoard(final Builder builder)
	{
...
//        builder.setPiece(new SiegeMachine(Alliance.BLACK, 17));
//        builder.setPiece(new Zebra(Alliance.BLACK, 19));
//        builder.setPiece(new Zebra(Alliance.BLACK, 20));
//        builder.setPiece(new SiegeMachine(Alliance.BLACK, 22));
        // White Layout
//        builder.setPiece(new SiegeMachine(Alliance.WHITE, 41));
//        builder.setPiece(new Zebra(Alliance.WHITE, 43));
//        builder.setPiece(new Zebra(Alliance.WHITE, 44));
//        builder.setPiece(new SiegeMachine(Alliance.WHITE, 46));
	...
	public static class Builder // TODO: What is a Builder in Java ?
	{
